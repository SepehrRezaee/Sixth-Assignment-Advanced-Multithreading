...
public class Resource {
    ...
    public static void accessResource(String threadName) {
        try {
            semaphore.acquire();
            System.out.println(threadName + " entered the critical section at " + System.nanoTime());
            ...
            semaphore.release();
            System.out.println(threadName + " exiting the critical section at " + System.nanoTime());
        }
    }
}
